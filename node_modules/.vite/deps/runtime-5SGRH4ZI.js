...
// node_modules/.deno/honox@0.1.39/node_modules/honox/dist/client/runtime.js
var buildCreateChildrenFn = (createElement, importComponent) => {
  let keyIndex = 0;
  const setChildrenFromTemplate = async (props, element) => {
    const maybeTemplate = element.childNodes[element.childNodes.length - 1];
    if ((maybeTemplate == null ? void 0 : maybeTemplate.nodeName) === "TEMPLATE" && (maybeTemplate == null ? void 0 : maybeTemplate.getAttribute(DATA_HONO_TEMPLATE)) !== null) {
...
var hydrateComponentHonoSuspense = async (hydrateComponent) => {
...
//# sourceMappingURL=runtime-5SGRH4ZI.js.map
